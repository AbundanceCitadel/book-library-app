...
// pill, hash-synced active tab) — same mechanics as BookTabs.tsx's own
// sticky/pill/hash-sync logic, extracted so the seven tabbed sections
// (People/Rich List/Rulers/Organizations/Companies/Civilizations/
// Philosophies) share one implementation instead of each reimplementing the
// same ~80 lines. BookTabs.tsx itself is left untouched.
